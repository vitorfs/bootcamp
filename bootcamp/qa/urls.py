...
urlpatterns = [
    ...
    url(r"^tag/(?P<tag>[-\w]+)/$", views.QuestionListView.as_view(), name="index_noans_tagged"),
    url(r"^answered/tag/(?P<tag>[-\w]+)/$", views.QuestionAnsListView.as_view(), name="index_ans_tagged"),
    url(r"^indexed/tag/(?P<tag>[-\w]+)/$", views.QuestionsIndexListView.as_view(), name="index_all_tagged"),
]
